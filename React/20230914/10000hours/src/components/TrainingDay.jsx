    ...
    return (
        <div className='be-trained'>
            ...
            <div className='flex-wrap gap-10 btn-wrap'>
                <button type='button' className='yellowBtn' onClick={goModal}>훈련하러 가기 GO!GO!</button>
                {modalShow && <GoModal setModalShow={setModalShow} />}
                <button type='button' className='whiteBtn'>공유하기</button>
            </div>
        </div>
    )
}
